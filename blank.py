...
for i in range(N):
	...
	svg = svg.replace("VEO_WIFI_SSID", "VEOCAM-_ _ _")
	svg = svg.replace("*000000000000*", "")
	svg = svg.replace("000000000000", ix[2:-3].upper()+"_ _ _")
...
v, r = getCmd("pdfunite " + ' '.join(pdffiles) + " blank.pdf") 
